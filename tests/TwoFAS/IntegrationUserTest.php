...
class IntegrationUserTest extends LiveAndMockBase
{
    ...
    public function testGetIntegrationUser(IntegrationUser $user)
    {
        $response = array(
            ...
            'external_id'        => null,
            'active_method'      => 'totp',
            'phone_number'       => 'cHcrUHFFc1A0WGtBQUsrVlFDY2M3dz09:Nwema7YMeodxdHHneevhCw==',
            'email'              => 'TXpKZnR2bGcyY1RZVGl0SEV6Sjhndz09:/UDSxNlRe2UCQX85lOYH1A==',
            'totp_secret'        => "MVRZOWlpU29BbDZsS0xVNThXT2trY0FtNXV6RkJDdG5ueGU1K0ZlZEo1ST0=:OfnQGEV+2Yi4UiO6K8VunQ==",
